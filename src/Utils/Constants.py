...
recall_precision_with_human_labels_pdf_output_path : Path = base_pdf_path / "RecallPrecision" / "recall_precision_with_human_labels.pdf"
recall_precision_ai_pdf_output_path: Path = base_pdf_path / "RecallPrecision" / "recall_precision_ai.pdf"
